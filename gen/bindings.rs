...
pub const VkStructureType_VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_KHR: VkStructureType =
    1000150006;
pub const VkStructureType_VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_INFO_KHR: VkStructureType =
    1000150007;
...
pub const VkGeometryTypeKHR_VK_GEOMETRY_TYPE_BEGIN_RANGE_KHR: VkGeometryTypeKHR = 0;
pub const VkGeometryTypeKHR_VK_GEOMETRY_TYPE_END_RANGE_KHR: VkGeometryTypeKHR = 1;
pub const VkGeometryTypeKHR_VK_GEOMETRY_TYPE_RANGE_SIZE_KHR: VkGeometryTypeKHR = 2;
...
pub const VkAccelerationStructureTypeKHR_VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_NV:
    VkAccelerationStructureTypeKHR = 1;
pub const VkAccelerationStructureTypeKHR_VK_ACCELERATION_STRUCTURE_TYPE_BEGIN_RANGE_KHR:
    VkAccelerationStructureTypeKHR = 0;
pub const VkAccelerationStructureTypeKHR_VK_ACCELERATION_STRUCTURE_TYPE_END_RANGE_KHR:
    VkAccelerationStructureTypeKHR = 1;
pub const VkAccelerationStructureTypeKHR_VK_ACCELERATION_STRUCTURE_TYPE_RANGE_SIZE_KHR:
...
pub const VkAccelerationStructureMemoryRequirementsTypeKHR_VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_BEGIN_RANGE_KHR : VkAccelerationStructureMemoryRequirementsTypeKHR = 0 ;
pub const VkAccelerationStructureMemoryRequirementsTypeKHR_VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_END_RANGE_KHR : VkAccelerationStructureMemoryRequirementsTypeKHR = 2 ;
pub const VkAccelerationStructureMemoryRequirementsTypeKHR_VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_RANGE_SIZE_KHR : VkAccelerationStructureMemoryRequirementsTypeKHR = 3 ;
...
pub type VkAccelerationStructureMemoryRequirementsTypeKHR = u32;
...
pub const VkAccelerationStructureBuildTypeKHR_VK_ACCELERATION_STRUCTURE_BUILD_TYPE_BEGIN_RANGE_KHR : VkAccelerationStructureBuildTypeKHR = 0 ;
pub const VkAccelerationStructureBuildTypeKHR_VK_ACCELERATION_STRUCTURE_BUILD_TYPE_END_RANGE_KHR:
    VkAccelerationStructureBuildTypeKHR = 2;
pub const VkAccelerationStructureBuildTypeKHR_VK_ACCELERATION_STRUCTURE_BUILD_TYPE_RANGE_SIZE_KHR : VkAccelerationStructureBuildTypeKHR = 3 ;
...
pub struct VkAccelerationStructureMemoryRequirementsInfoKHR {
    pub sType: VkStructureType,
    pub pNext: *const ::std::os::raw::c_void,
    pub type_: VkAccelerationStructureMemoryRequirementsTypeKHR,
...
>;
pub type PFN_vkGetAccelerationStructureMemoryRequirementsKHR = ::std::option::Option<
    unsafe extern "C" fn(
        device: VkDevice,
...
pub struct VmaVulkanFunctions {
    ...
    pub vkGetAccelerationStructureMemoryRequirementsKHR:
        PFN_vkGetAccelerationStructureMemoryRequirementsKHR,
    pub vkBindAccelerationStructureMemoryKHR: PFN_vkBindAccelerationStructureMemoryKHR,
}
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "TODO"]
    pub fn vmaCreateAccelerationStructure(
        allocator: VmaAllocator,
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "TODO"]
    pub fn vmaDestroyAccelerationStructure(
        allocator: VmaAllocator,
        accelerationStructrure: VkAccelerationStructureKHR,
        allocation: VmaAllocation,
    );
}
extern "C" {
    #[doc = " \\brief Creates a buffer suitable for build or update of ray tracing acceleration structure."]
    #[doc = ""]
    #[doc = "The function is similar to vmaCreateBuffer(), but it automatically calculates"]
    #[doc = "required size based on given acceleration structure parameters."]
    #[doc = "`type` must be `VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_BUILD_SCRATCH_KHR`"]
    #[doc = "or `VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_UPDATE_SCRATCH_KHR`."]
    #[doc = ""]
    #[doc = "`pBufferCreateInfo->size` can be zero. If its value not zero, the size of the"]
    #[doc = "created buffer is maximum of this value and the required size calculated based"]
    #[doc = "on the acceleration structure."]
    #[doc = ""]
    #[doc = "You can free the buffer normally when no longer needed e.g. using vmaDestroyBuffer()."]
    pub fn vmaCreateAccelerationStructureScratchBuffer(
        allocator: VmaAllocator,
        type_: VkAccelerationStructureMemoryRequirementsTypeKHR,
        accelerationStructure: VkAccelerationStructureKHR,
        pBufferCreateInfo: *const VkBufferCreateInfo,
        pAllocationCreateInfo: *const VmaAllocationCreateInfo,
        pBuffer: *mut VkBuffer,
